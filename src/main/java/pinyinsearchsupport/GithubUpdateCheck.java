...
final class GithubUpdateCheck{
    ...
    private static final String repo = "PinyinSearchSupport";
    private static final String modName = "pinyin-search-support";
    ...
    private static final String keyUpdateCheckEnabled = "pss-updatecheck";
    private static final String keyUpdateCheckShowDialog = "pss-updatecheck-dialog";
    private static final String keyUpdateCheckLastAt = "pss-updatecheck-lastAt";
    private static final String keyUpdateCheckIgnoreVersion = "pss-updatecheck-ignore";
    private static final String keyUpdateCheckUseMirror = "pss-updatecheck-mirror";
    ...
    static void checkOnce(){
        ...
        .error(e -> checkFromRawModJson(mod, current, ignored))
        .submit(res -> {
            try{
